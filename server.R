...
#    progress$set(message="Knitting!",detail="bla bla bla")
    ...
    paste(#paste(readLines("templates/navbar.rms"), collapse="\n"),
        ...
        "<script>$('#analysis pre code').each(function(i, e) {hljs.highlightBlock(e)});</script>", 
        "<script type='text/javascript'>generateTOC($('#toc')[0], $('#analysis')[0]);</script>",
        sep = '\n')
      
    #TODO: explore useing markdown package highlight_code option and html.header in new version - wont work as fragment only

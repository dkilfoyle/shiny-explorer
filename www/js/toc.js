 ...
 * Modified by DK to stop numbering headers and to specifiy which div of document to build toc from
 */
...
function generateTOC(toc, mybody) {
	var i2 = 0, i3 = 0, i4 = 0;
	toc = toc.appendChild(document.createElement("ul"));
	for (var i = 0; i < mybody.childNodes.length; ++i) {
		var node = mybody.childNodes[i];
